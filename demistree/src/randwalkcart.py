...
@jit(nopython=True)
def periodicboundary(x, boxsize):
    """
...
@jit(nopython=True)
def randwalkcart2d(steps, prand, boxsize, x0, y0, useperiodic):
    """
...
@jit(nopython=True)
def randwalkcart3d(steps, prand, trand, boxsize, x0, y0, z0, useperiodic):
    """
